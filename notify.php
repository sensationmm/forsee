...
if($DataArea->AssessmentReport->AssessmentResult->Attachment->AttachmentID && $DataArea->AssessmentReport->AssessmentResult->Attachment->FileName && $DataArea->AssessmentReport->AssessmentResult->Attachment->EmbeddedData){
	...
	$PDF_Report_FN = $DataArea->AssessmentReport->AssessmentSubject->SubjectID."_".$DataArea->AssessmentReport->AssessmentResult->Attachment->AttachmentID."_".uniqid().".pdf";
	//$PDF_Report_FN = mb_ereg_replace("([^\w\s\d\-_~,;:\[\]\(\).])", '', $PDF_Report_FN);
...
if($DataArea->AssessmentReport->DocumentID && $DataArea->AssessmentReport->AssessmentSubject->SubjectID && $DataArea->AssessmentReport->AssessmentResult->AssessmentStatus->AssessmentStatusCode && $Process_HA_Data_Results){	
	...
	if($DataArea->AssessmentReport->DocumentID=='ForseeSurvey1' && $DataArea->AssessmentReport->AssessmentResult->AssessmentStatus->AssessmentStatusCode=='OrderCompleted'){
		...
		if($DataArea->AssessmentReport->AssessmentResult->AssessmentDetailedResult){
			...
			if($Count_Career_Options==10){
				...
				$Have_We_Requested_Any_Reports_Before = Get_primary_reports_requested($User_subject_id,'Ygs');
