	...
	public function bundled_product_admin_config_html( $loop, $product_id, $item_data, $post_id ) {
		...
		<div class="max_quantity">
			<div class="form-field">
				...
				<img class="help_tip" data-tip="<?php echo __( 'The maximum quantity of this bundled product. Leave the field empty for an unlimited maximum quantity.', 'woocommerce-product-bundles' ); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" />
			</div>
		</div>
		...
		?><div class="item_visibility">
			<div class="form-field">
				...
				<div>
					...
					<img class="help_tip" data-tip="<?php echo __( 'Controls the visibility of this bundled product in the single-product template. Not recommended for variable products, unless default attribute selections (or default selection overrides) have been set.', 'woocommerce-product-bundles' ); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" />
				</div>
				<div>
					...
					<img class="help_tip" data-tip="<?php echo __( 'Controls the visibility of this bundled product in the cart template.', 'woocommerce-product-bundles' ); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" />
				</div>
				<div>
					...
					<img class="help_tip" data-tip="<?php echo __( 'Controls the visibility of this bundled product in the order &amp; e-mail templates.', 'woocommerce-product-bundles' ); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" />
				</div>
			</div>
		</div>
